 ...
 */
audio_utils.worker.main_entry_node = (function audio_utils$worker$main_entry_node(worker,ctx,p__11505){
var map__11509 = p__11505;
var map__11509__$1 = ((((!((map__11509 == null)))?((((map__11509.cljs$lang$protocol_mask$partition0$ & (64))) || (map__11509.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11509):map__11509);
var buffer_size = cljs.core.get.call(null,map__11509__$1,new cljs.core.Keyword(null,"buffer-size","buffer-size",1047120420),(4096));
var input_channels = cljs.core.get.call(null,map__11509__$1,new cljs.core.Keyword(null,"input-channels","input-channels",-1514165896),(1));
var output_channels = cljs.core.get.call(null,map__11509__$1,new cljs.core.Keyword(null,"output-channels","output-channels",488402049),(1));
var G__11511 = ctx.createScriptProcessor(buffer_size,input_channels,output_channels);
(G__11511["onaudioprocess"] = ((function (G__11511,map__11509,map__11509__$1,buffer_size,input_channels,output_channels){
...
var n__7389__auto___11512 = n_channels;
var channel_11513 = (0);
while(true){
if((channel_11513 < n__7389__auto___11512)){
var input_data_11514 = input_buffer.getChannelData(channel_11513);
var output_data_11515 = output_buffer.getChannelData(channel_11513);
var n__7389__auto___11516__$1 = input_data_11514.length;
var n_11517 = (0);
while(true){
if((n_11517 < n__7389__auto___11516__$1)){
var sample_11518 = (input_data_11514[n_11517]);
(output_data_11515[n_11517] = sample_11518);

(worker_data[channel_11513]).push(sample_11518);

var G__11519 = (n_11517 + (1));
n_11517 = G__11519;
continue;
} else {
}
...
var G__11520 = (channel_11513 + (1));
channel_11513 = G__11520;
continue;
} else {
}
break;
...
});})(G__11511,map__11509,map__11509__$1,buffer_size,input_channels,output_channels))
);
...
var node = (function (){
if(typeof audio_utils.worker.t_audio_utils$worker11524 !== 'undefined'){
} else {
...
*/
audio_utils.worker.t_audio_utils$worker11524 = (function (worker_entry_node,next,meta11525){
...
audio_utils.worker.t_audio_utils$worker11524.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (next){
return (function (_11526,meta11525__$1){
var self__ = this;
var _11526__$1 = this;
return (new audio_utils.worker.t_audio_utils$worker11524(self__.worker_entry_node,self__.next,meta11525__$1));
});})(next))
;

audio_utils.worker.t_audio_utils$worker11524.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (next){
...
audio_utils.worker.t_audio_utils$worker11524.prototype.audio_utils$worker$IWorkerAudioNode$ = true;

audio_utils.worker.t_audio_utils$worker11524.prototype.audio_utils$worker$IWorkerAudioNode$connect$arity$2 = ((function (next){
...
audio_utils.worker.t_audio_utils$worker11524.prototype.audio_utils$worker$IWorkerAudioNode$disconnect$arity$1 = ((function (next){
...
audio_utils.worker.t_audio_utils$worker11524.prototype.audio_utils$worker$IWorkerAudioNode$process_audio$arity$2 = ((function (next){
...
audio_utils.worker.t_audio_utils$worker11524.getBasis = ((function (next){
return (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"worker-entry-node","worker-entry-node",430315289,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),cljs.core.list(new cljs.core.Symbol(null,"quote","quote",1377916282,null),cljs.core.list(cljs.core.PersistentVector.EMPTY)),new cljs.core.Keyword(null,"doc","doc",1913296891),"Creates an IWorkerAudioNode in a worker that receives its audio\n   data from the main UI thread via a :worker-process-audio message.\n   It then forwards the audio to the next IWorkerAudioNode if\n   there is one."], null)),new cljs.core.Symbol(null,"next","next",1522830042,null),new cljs.core.Symbol(null,"meta11525","meta11525",-146559941,null)], null);
});})(next))
;

audio_utils.worker.t_audio_utils$worker11524.cljs$lang$type = true;

audio_utils.worker.t_audio_utils$worker11524.cljs$lang$ctorStr = "audio-utils.worker/t_audio_utils$worker11524";

audio_utils.worker.t_audio_utils$worker11524.cljs$lang$ctorPrWriter = ((function (next){
return (function (this__7084__auto__,writer__7085__auto__,opt__7086__auto__){
return cljs.core._write.call(null,writer__7085__auto__,"audio-utils.worker/t_audio_utils$worker11524");
});})(next))
;

audio_utils.worker.__GT_t_audio_utils$worker11524 = ((function (next){
return (function audio_utils$worker$worker_entry_node_$___GT_t_audio_utils$worker11524(worker_entry_node__$1,next__$1,meta11525){
return (new audio_utils.worker.t_audio_utils$worker11524(worker_entry_node__$1,next__$1,meta11525));
});})(next))
;

}

return (new audio_utils.worker.t_audio_utils$worker11524(audio_utils$worker$worker_entry_node,next,cljs.core.PersistentArrayMap.EMPTY));
})()
;
...
if(typeof audio_utils.worker.t_audio_utils$worker11530 !== 'undefined'){
} else {
 ...
 * @implements {cljs.core.IWithMeta}
*/
audio_utils.worker.t_audio_utils$worker11530 = (function (worker_exit_node,meta11531){
this.worker_exit_node = worker_exit_node;
this.meta11531 = meta11531;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
})
audio_utils.worker.t_audio_utils$worker11530.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11532,meta11531__$1){
var self__ = this;
var _11532__$1 = this;
return (new audio_utils.worker.t_audio_utils$worker11530(self__.worker_exit_node,meta11531__$1));
});

audio_utils.worker.t_audio_utils$worker11530.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11532){
var self__ = this;
var _11532__$1 = this;
return self__.meta11531;
});

audio_utils.worker.t_audio_utils$worker11530.prototype.audio_utils$worker$IWorkerAudioNode$ = true;

audio_utils.worker.t_audio_utils$worker11530.prototype.audio_utils$worker$IWorkerAudioNode$connect$arity$2 = (function (this$,destination){
var self__ = this;
var this$__$1 = this;
return null;
});

audio_utils.worker.t_audio_utils$worker11530.prototype.audio_utils$worker$IWorkerAudioNode$disconnect$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return null;
});

audio_utils.worker.t_audio_utils$worker11530.prototype.audio_utils$worker$IWorkerAudioNode$process_audio$arity$2 = (function (this$,data){
var self__ = this;
var this$__$1 = this;
...
audio_utils.worker.t_audio_utils$worker11530.getBasis = (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"worker-exit-node","worker-exit-node",-1756103158,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),cljs.core.list(new cljs.core.Symbol(null,"quote","quote",1377916282,null),cljs.core.list(cljs.core.PersistentVector.EMPTY)),new cljs.core.Keyword(null,"doc","doc",1913296891),"Creates an IWorkerAudioNode that takes audio data from a previous\n   IWorkerAudioNode and forwards it to the main UI thread via a\n   :main-process-audio message."], null)),new cljs.core.Symbol(null,"meta11531","meta11531",856556692,null)], null);
});

audio_utils.worker.t_audio_utils$worker11530.cljs$lang$type = true;

audio_utils.worker.t_audio_utils$worker11530.cljs$lang$ctorStr = "audio-utils.worker/t_audio_utils$worker11530";

audio_utils.worker.t_audio_utils$worker11530.cljs$lang$ctorPrWriter = (function (this__7084__auto__,writer__7085__auto__,opt__7086__auto__){
return cljs.core._write.call(null,writer__7085__auto__,"audio-utils.worker/t_audio_utils$worker11530");
});

audio_utils.worker.__GT_t_audio_utils$worker11530 = (function audio_utils$worker$worker_exit_node_$___GT_t_audio_utils$worker11530(worker_exit_node__$1,meta11531){
return (new audio_utils.worker.t_audio_utils$worker11530(worker_exit_node__$1,meta11531));
});

}

return (new audio_utils.worker.t_audio_utils$worker11530(audio_utils$worker$worker_exit_node,cljs.core.PersistentArrayMap.EMPTY));
});
