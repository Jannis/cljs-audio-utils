...
audio_utils.chunker.Chunker.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__7102__auto__,k11537,else__7103__auto__){
var self__ = this;
var this__7102__auto____$1 = this;
var G__11539 = (((k11537 instanceof cljs.core.Keyword))?k11537.fqn:null);
switch (G__11539) {
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k11537,else__7103__auto__);
...
var samples_11545 = cljs.core.mapv.call(null,((function (n,n__7389__auto__,n_samples,n_channels,this$__$1){
return (function (p1__11535_SHARP_){
return data.call(null,p1__11535_SHARP_).call(null,n);
});})(n,n__7389__auto__,n_samples,n_channels,this$__$1))
,cljs.core.range.call(null,(0),n_channels));
audio_utils.chunker.process_samples.call(null,this$__$1,samples_11545);
...
audio_utils.chunker.Chunker.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__7107__auto__,k__7108__auto__,G__11536){
var self__ = this;
var this__7107__auto____$1 = this;
var pred__11540 = cljs.core.keyword_identical_QMARK_;
var expr__11541 = k__7108__auto__;
if(cljs.core.truth_(pred__11540.call(null,new cljs.core.Keyword(null,"samples-per-chunk","samples-per-chunk",-184645826),expr__11541))){
return (new audio_utils.chunker.Chunker(G__11536,self__.next,self__.chunks,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11540.call(null,new cljs.core.Keyword(null,"next","next",-117701485),expr__11541))){
return (new audio_utils.chunker.Chunker(self__.samples_per_chunk,G__11536,self__.chunks,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11540.call(null,new cljs.core.Keyword(null,"chunks","chunks",83720431),expr__11541))){
return (new audio_utils.chunker.Chunker(self__.samples_per_chunk,self__.next,G__11536,self__.__meta,self__.__extmap,null));
} else {
return (new audio_utils.chunker.Chunker(self__.samples_per_chunk,self__.next,self__.chunks,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__7108__auto__,G__11536),null));
}
}
}
});
...
var self__ = this;
var this$__$1 = this;
var n__7389__auto___11547 = cljs.core.count.call(null,samples);
var channel_11548 = (0);
while(true){
if((channel_11548 < n__7389__auto___11547)){
var sample_11549 = samples.call(null,channel_11548);
cljs.core.swap_BANG_.call(null,self__.chunks,cljs.core.update,channel_11548,cljs.core.conj,sample_11549);

var G__11550 = (channel_11548 + (1));
channel_11548 = G__11550;
continue;
} else {
}
break;
...
var self__ = this;
var this$__$1 = this;
var G__11543 = cljs.core.deref.call(null,self__.next);
if((G__11543 == null)){
return null;
} else {
return audio_utils.worker.process_audio.call(null,G__11543,cljs.core.deref.call(null,self__.chunks));
}
});
...
audio_utils.chunker.Chunker.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__7099__auto__,G__11536){
var self__ = this;
var this__7099__auto____$1 = this;
return (new audio_utils.chunker.Chunker(self__.samples_per_chunk,self__.next,self__.chunks,G__11536,self__.__extmap,self__.__hash));
});
...
audio_utils.chunker.map__GT_Chunker = (function audio_utils$chunker$map__GT_Chunker(G__11538){
return (new audio_utils.chunker.Chunker(new cljs.core.Keyword(null,"samples-per-chunk","samples-per-chunk",-184645826).cljs$core$IFn$_invoke$arity$1(G__11538),new cljs.core.Keyword(null,"next","next",-117701485).cljs$core$IFn$_invoke$arity$1(G__11538),new cljs.core.Keyword(null,"chunks","chunks",83720431).cljs$core$IFn$_invoke$arity$1(G__11538),null,cljs.core.dissoc.call(null,G__11538,new cljs.core.Keyword(null,"samples-per-chunk","samples-per-chunk",-184645826),new cljs.core.Keyword(null,"next","next",-117701485),new cljs.core.Keyword(null,"chunks","chunks",83720431)),null));
});

audio_utils.chunker.chunker = (function audio_utils$chunker$chunker(p__11551){
var map__11554 = p__11551;
...
var samples_per_chunk = cljs.core.get.call(null,map__11554__$1,new cljs.core.Keyword(null,"samples-per-chunk","samples-per-chunk",-184645826),(4410));
