...
audio_utils.rms_buffer.RMSBuffer.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__7102__auto__,k21146,else__7103__auto__){
var self__ = this;
var this__7102__auto____$1 = this;
var G__21151 = (((k21146 instanceof cljs.core.Keyword))?k21146.fqn:null);
switch (G__21151) {
case "size":
return self__.size;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k21146,else__7103__auto__);
...
return cljs.core.assoc.call(null,cljs.core.assoc.call(null,this$__$1,new cljs.core.Keyword(null,"samples","samples",635504833),cljs.core.conj.call(null,(function (){var G__21157 = self__.samples;
if((n_samples >= self__.size)){
return cljs.core.pop.call(null,G__21157);
} else {
return G__21157;
}
...
var G__21201 = audio_utils.rms_buffer.rms_push.call(null,buf,cljs.core.first.call(null,xs));
var G__21202 = cljs.core.rest.call(null,xs);
buf = G__21201;
xs = G__21202;
continue;
}
...
audio_utils.rms_buffer.RMSBuffer.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__7107__auto__,k__7108__auto__,G__21145){
var self__ = this;
var this__7107__auto____$1 = this;
var pred__21158 = cljs.core.keyword_identical_QMARK_;
var expr__21159 = k__7108__auto__;
if(cljs.core.truth_(pred__21158.call(null,new cljs.core.Keyword(null,"size","size",1098693007),expr__21159))){
return (new audio_utils.rms_buffer.RMSBuffer(G__21145,self__.samples,self__.squared_sum,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__21158.call(null,new cljs.core.Keyword(null,"samples","samples",635504833),expr__21159))){
return (new audio_utils.rms_buffer.RMSBuffer(self__.size,G__21145,self__.squared_sum,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__21158.call(null,new cljs.core.Keyword(null,"squared-sum","squared-sum",809966250),expr__21159))){
return (new audio_utils.rms_buffer.RMSBuffer(self__.size,self__.samples,G__21145,self__.__meta,self__.__extmap,null));
} else {
return (new audio_utils.rms_buffer.RMSBuffer(self__.size,self__.samples,self__.squared_sum,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__7108__auto__,G__21145),null));
}
}
}
});
...
audio_utils.rms_buffer.RMSBuffer.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__7099__auto__,G__21145){
var self__ = this;
var this__7099__auto____$1 = this;
return (new audio_utils.rms_buffer.RMSBuffer(self__.size,self__.samples,self__.squared_sum,G__21145,self__.__extmap,self__.__hash));
});
...
audio_utils.rms_buffer.map__GT_RMSBuffer = (function audio_utils$rms_buffer$map__GT_RMSBuffer(G__21150){
return (new audio_utils.rms_buffer.RMSBuffer(new cljs.core.Keyword(null,"size","size",1098693007).cljs$core$IFn$_invoke$arity$1(G__21150),new cljs.core.Keyword(null,"samples","samples",635504833).cljs$core$IFn$_invoke$arity$1(G__21150),new cljs.core.Keyword(null,"squared-sum","squared-sum",809966250).cljs$core$IFn$_invoke$arity$1(G__21150),null,cljs.core.dissoc.call(null,G__21150,new cljs.core.Keyword(null,"size","size",1098693007),new cljs.core.Keyword(null,"samples","samples",635504833),new cljs.core.Keyword(null,"squared-sum","squared-sum",809966250)),null));
});
