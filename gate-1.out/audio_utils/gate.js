...
audio_utils.gate.Gate.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__7102__auto__,k11567,else__7103__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k11567,else__7103__auto__);
...
audio_utils.gate.Gate.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__11566){
var self__ = this;
var G__11566__$1 = this;
return (new cljs.core.RecordIter((0),G__11566__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"next","next",-117701485),new cljs.core.Keyword(null,"buffers","buffers",471409492),new cljs.core.Keyword(null,"rms-buffers","rms-buffers",-1681500464),new cljs.core.Keyword(null,"samples-held","samples-held",-1945118922)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
var n__7389__auto___11575 = n_samples;
var n_11576 = (0);
while(true){
if((n_11576 < n__7389__auto___11575)){
var n__7389__auto___11577__$1 = n_channels;
var channel_11578 = (0);
while(true){
if((channel_11578 < n__7389__auto___11577__$1)){
var input_sample_11579 = data.call(null,channel_11578).call(null,n_11576);
var output_sample_11580 = audio_utils.gate.generate_output_sample.call(null,this$__$1,channel_11578,input_sample_11579);
cljs.core._vreset_BANG_.call(null,output,cljs.core.update.call(null,cljs.core._deref.call(null,output),channel_11578,cljs.core.conj,output_sample_11580));

var G__11581 = (channel_11578 + (1));
channel_11578 = G__11581;
continue;
} else {
}
break;
...
var G__11570 = cljs.core.deref.call(null,self__.next);
if((G__11570 == null)){
return null;
} else {
return audio_utils.worker.process_audio.call(null,G__11570,cljs.core.deref.call(null,output));
}
});
...
audio_utils.gate.Gate.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__7107__auto__,k__7108__auto__,G__11566){
var self__ = this;
var this__7107__auto____$1 = this;
var pred__11571 = cljs.core.keyword_identical_QMARK_;
var expr__11572 = k__7108__auto__;
if(cljs.core.truth_(pred__11571.call(null,new cljs.core.Keyword(null,"config","config",994861415),expr__11572))){
return (new audio_utils.gate.Gate(G__11566,self__.next,self__.buffers,self__.rms_buffers,self__.samples_held,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11571.call(null,new cljs.core.Keyword(null,"next","next",-117701485),expr__11572))){
return (new audio_utils.gate.Gate(self__.config,G__11566,self__.buffers,self__.rms_buffers,self__.samples_held,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11571.call(null,new cljs.core.Keyword(null,"buffers","buffers",471409492),expr__11572))){
return (new audio_utils.gate.Gate(self__.config,self__.next,G__11566,self__.rms_buffers,self__.samples_held,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11571.call(null,new cljs.core.Keyword(null,"rms-buffers","rms-buffers",-1681500464),expr__11572))){
return (new audio_utils.gate.Gate(self__.config,self__.next,self__.buffers,G__11566,self__.samples_held,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11571.call(null,new cljs.core.Keyword(null,"samples-held","samples-held",-1945118922),expr__11572))){
return (new audio_utils.gate.Gate(self__.config,self__.next,self__.buffers,self__.rms_buffers,G__11566,self__.__meta,self__.__extmap,null));
} else {
return (new audio_utils.gate.Gate(self__.config,self__.next,self__.buffers,self__.rms_buffers,self__.samples_held,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__7108__auto__,G__11566),null));
}
}
}
}
...
audio_utils.gate.Gate.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__7099__auto__,G__11566){
var self__ = this;
var this__7099__auto____$1 = this;
return (new audio_utils.gate.Gate(self__.config,self__.next,self__.buffers,self__.rms_buffers,self__.samples_held,G__11566,self__.__extmap,self__.__hash));
});
...
audio_utils.gate.map__GT_Gate = (function audio_utils$gate$map__GT_Gate(G__11568){
return (new audio_utils.gate.Gate(new cljs.core.Keyword(null,"config","config",994861415).cljs$core$IFn$_invoke$arity$1(G__11568),new cljs.core.Keyword(null,"next","next",-117701485).cljs$core$IFn$_invoke$arity$1(G__11568),new cljs.core.Keyword(null,"buffers","buffers",471409492).cljs$core$IFn$_invoke$arity$1(G__11568),new cljs.core.Keyword(null,"rms-buffers","rms-buffers",-1681500464).cljs$core$IFn$_invoke$arity$1(G__11568),new cljs.core.Keyword(null,"samples-held","samples-held",-1945118922).cljs$core$IFn$_invoke$arity$1(G__11568),null,cljs.core.dissoc.call(null,G__11568,new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"next","next",-117701485),new cljs.core.Keyword(null,"buffers","buffers",471409492),new cljs.core.Keyword(null,"rms-buffers","rms-buffers",-1681500464),new cljs.core.Keyword(null,"samples-held","samples-held",-1945118922)),null));
});

audio_utils.gate.default_trigger = (function audio_utils$gate$default_trigger(gate,state){
return null;
});
audio_utils.gate.gate = (function audio_utils$gate$gate(p__11583){
var map__11586 = p__11583;
...
var sample_rate = cljs.core.get.call(null,map__11586__$1,new cljs.core.Keyword(null,"sample-rate","sample-rate",-603246554));
var buffer_size = cljs.core.get.call(null,map__11586__$1,new cljs.core.Keyword(null,"buffer-size","buffer-size",1047120420),(4096));
var threshold = cljs.core.get.call(null,map__11586__$1,new cljs.core.Keyword(null,"threshold","threshold",204221583),-32.0);
var look_ahead = cljs.core.get.call(null,map__11586__$1,new cljs.core.Keyword(null,"look-ahead","look-ahead",344278596),(500));
var hold = cljs.core.get.call(null,map__11586__$1,new cljs.core.Keyword(null,"hold","hold",-1621118005),(100));
var rms_window = cljs.core.get.call(null,map__11586__$1,new cljs.core.Keyword(null,"rms-window","rms-window",-1227165349),(100));
var trigger = cljs.core.get.call(null,map__11586__$1,new cljs.core.Keyword(null,"trigger","trigger",103466139),audio_utils.gate.default_trigger);
