 ...
 */
audio_utils.worker.main_entry_node = (function audio_utils$worker$main_entry_node(worker,ctx,p__11514){
var map__11518 = p__11514;
var map__11518__$1 = ((((!((map__11518 == null)))?((((map__11518.cljs$lang$protocol_mask$partition0$ & (64))) || (map__11518.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11518):map__11518);
var buffer_size = cljs.core.get.call(null,map__11518__$1,new cljs.core.Keyword(null,"buffer-size","buffer-size",1047120420),(4096));
var input_channels = cljs.core.get.call(null,map__11518__$1,new cljs.core.Keyword(null,"input-channels","input-channels",-1514165896),(1));
var output_channels = cljs.core.get.call(null,map__11518__$1,new cljs.core.Keyword(null,"output-channels","output-channels",488402049),(1));
var G__11520 = ctx.createScriptProcessor(buffer_size,input_channels,output_channels);
(G__11520["onaudioprocess"] = ((function (G__11520,map__11518,map__11518__$1,buffer_size,input_channels,output_channels){
...
var n__7389__auto___11521 = n_channels;
var channel_11522 = (0);
while(true){
if((channel_11522 < n__7389__auto___11521)){
var input_data_11523 = input_buffer.getChannelData(channel_11522);
var output_data_11524 = output_buffer.getChannelData(channel_11522);
var n__7389__auto___11525__$1 = input_data_11523.length;
var n_11526 = (0);
while(true){
if((n_11526 < n__7389__auto___11525__$1)){
var sample_11527 = (input_data_11523[n_11526]);
(output_data_11524[n_11526] = sample_11527);

(worker_data[channel_11522]).push(sample_11527);

var G__11528 = (n_11526 + (1));
n_11526 = G__11528;
continue;
} else {
}
...
var G__11529 = (channel_11522 + (1));
channel_11522 = G__11529;
continue;
} else {
}
break;
...
});})(G__11520,map__11518,map__11518__$1,buffer_size,input_channels,output_channels))
);
...
var node = (function (){
if(typeof audio_utils.worker.t_audio_utils$worker11535 !== 'undefined'){
} else {
...
*/
audio_utils.worker.t_audio_utils$worker11535 = (function (worker_entry_node,next,meta11536){
...
audio_utils.worker.t_audio_utils$worker11535.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (next){
return (function (_11537,meta11536__$1){
var self__ = this;
var _11537__$1 = this;
return (new audio_utils.worker.t_audio_utils$worker11535(self__.worker_entry_node,self__.next,meta11536__$1));
});})(next))
;

audio_utils.worker.t_audio_utils$worker11535.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (next){
return (function (_11537){
var self__ = this;
var _11537__$1 = this;
...
audio_utils.worker.t_audio_utils$worker11535.prototype.audio_utils$worker$IWorkerAudioNode$ = true;

audio_utils.worker.t_audio_utils$worker11535.prototype.audio_utils$worker$IWorkerAudioNode$connect$arity$2 = ((function (next){
...
audio_utils.worker.t_audio_utils$worker11535.prototype.audio_utils$worker$IWorkerAudioNode$disconnect$arity$1 = ((function (next){
...
audio_utils.worker.t_audio_utils$worker11535.prototype.audio_utils$worker$IWorkerAudioNode$process_audio$arity$2 = ((function (next){
...
audio_utils.worker.t_audio_utils$worker11535.getBasis = ((function (next){
return (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"worker-entry-node","worker-entry-node",430315289,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),cljs.core.list(new cljs.core.Symbol(null,"quote","quote",1377916282,null),cljs.core.list(cljs.core.PersistentVector.EMPTY)),new cljs.core.Keyword(null,"doc","doc",1913296891),"Creates an IWorkerAudioNode in a worker that receives its audio\n   data from the main UI thread via a :worker-process-audio message.\n   It then forwards the audio to the next IWorkerAudioNode if\n   there is one."], null)),new cljs.core.Symbol(null,"next","next",1522830042,null),new cljs.core.Symbol(null,"meta11536","meta11536",1775115601,null)], null);
});})(next))
;

audio_utils.worker.t_audio_utils$worker11535.cljs$lang$type = true;

audio_utils.worker.t_audio_utils$worker11535.cljs$lang$ctorStr = "audio-utils.worker/t_audio_utils$worker11535";

audio_utils.worker.t_audio_utils$worker11535.cljs$lang$ctorPrWriter = ((function (next){
return (function (this__7084__auto__,writer__7085__auto__,opt__7086__auto__){
return cljs.core._write.call(null,writer__7085__auto__,"audio-utils.worker/t_audio_utils$worker11535");
});})(next))
;

audio_utils.worker.__GT_t_audio_utils$worker11535 = ((function (next){
return (function audio_utils$worker$worker_entry_node_$___GT_t_audio_utils$worker11535(worker_entry_node__$1,next__$1,meta11536){
return (new audio_utils.worker.t_audio_utils$worker11535(worker_entry_node__$1,next__$1,meta11536));
});})(next))
;

}

return (new audio_utils.worker.t_audio_utils$worker11535(audio_utils$worker$worker_entry_node,next,cljs.core.PersistentArrayMap.EMPTY));
})()
;
