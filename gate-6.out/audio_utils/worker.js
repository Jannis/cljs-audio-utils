 ...
 */
audio_utils.worker.main_entry_node = (function audio_utils$worker$main_entry_node(worker,ctx,p__11510){
var map__11517 = p__11510;
...
var n__7389__auto___11520 = n_channels;
var channel_11521 = (0);
while(true){
if((channel_11521 < n__7389__auto___11520)){
var input_data_11522 = input_buffer.getChannelData(channel_11521);
var output_data_11523 = output_buffer.getChannelData(channel_11521);
var n__7389__auto___11524__$1 = input_data_11522.length;
var n_11525 = (0);
while(true){
if((n_11525 < n__7389__auto___11524__$1)){
var sample_11526 = (input_data_11522[n_11525]);
(output_data_11523[n_11525] = sample_11526);

(worker_data[channel_11521]).push(sample_11526);

var G__11527 = (n_11525 + (1));
n_11525 = G__11527;
continue;
} else {
}
...
var G__11528 = (channel_11521 + (1));
channel_11521 = G__11528;
continue;
} else {
}
break;
...
var node = (function (){
if(typeof audio_utils.worker.t_audio_utils$worker11533 !== 'undefined'){
} else {
...
*/
audio_utils.worker.t_audio_utils$worker11533 = (function (worker_entry_node,next,meta11534){
...
audio_utils.worker.t_audio_utils$worker11533.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (next){
return (function (_11535,meta11534__$1){
var self__ = this;
var _11535__$1 = this;
return (new audio_utils.worker.t_audio_utils$worker11533(self__.worker_entry_node,self__.next,meta11534__$1));
});})(next))
;

audio_utils.worker.t_audio_utils$worker11533.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (next){
...
audio_utils.worker.t_audio_utils$worker11533.prototype.audio_utils$worker$IWorkerAudioNode$ = true;

audio_utils.worker.t_audio_utils$worker11533.prototype.audio_utils$worker$IWorkerAudioNode$connect$arity$2 = ((function (next){
...
audio_utils.worker.t_audio_utils$worker11533.prototype.audio_utils$worker$IWorkerAudioNode$disconnect$arity$1 = ((function (next){
...
audio_utils.worker.t_audio_utils$worker11533.prototype.audio_utils$worker$IWorkerAudioNode$process_audio$arity$2 = ((function (next){
return (function (this$,data){
var self__ = this;
var this$__$1 = this;
if(cljs.core.deref.call(null,self__.next)){
...
audio_utils.worker.t_audio_utils$worker11533.getBasis = ((function (next){
return (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"worker-entry-node","worker-entry-node",430315289,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),cljs.core.list(new cljs.core.Symbol(null,"quote","quote",1377916282,null),cljs.core.list(cljs.core.PersistentVector.EMPTY)),new cljs.core.Keyword(null,"doc","doc",1913296891),"Creates an IWorkerAudioNode in a worker that receives its audio\n   data from the main UI thread via a :worker-process-audio message.\n   It then forwards the audio to the next IWorkerAudioNode if\n   there is one."], null)),new cljs.core.Symbol(null,"next","next",1522830042,null),new cljs.core.Symbol(null,"meta11534","meta11534",-29583748,null)], null);
});})(next))
;

audio_utils.worker.t_audio_utils$worker11533.cljs$lang$type = true;

audio_utils.worker.t_audio_utils$worker11533.cljs$lang$ctorStr = "audio-utils.worker/t_audio_utils$worker11533";

audio_utils.worker.t_audio_utils$worker11533.cljs$lang$ctorPrWriter = ((function (next){
return (function (this__7084__auto__,writer__7085__auto__,opt__7086__auto__){
return cljs.core._write.call(null,writer__7085__auto__,"audio-utils.worker/t_audio_utils$worker11533");
});})(next))
;

audio_utils.worker.__GT_t_audio_utils$worker11533 = ((function (next){
return (function audio_utils$worker$worker_entry_node_$___GT_t_audio_utils$worker11533(worker_entry_node__$1,next__$1,meta11534){
return (new audio_utils.worker.t_audio_utils$worker11533(worker_entry_node__$1,next__$1,meta11534));
});})(next))
;

}

return (new audio_utils.worker.t_audio_utils$worker11533(audio_utils$worker$worker_entry_node,next,cljs.core.PersistentArrayMap.EMPTY));
})()
;
...
if(typeof audio_utils.worker.t_audio_utils$worker11547 !== 'undefined'){
} else {
 ...
 * @implements {cljs.core.IWithMeta}
*/
audio_utils.worker.t_audio_utils$worker11547 = (function (worker_exit_node,meta11548){
this.worker_exit_node = worker_exit_node;
this.meta11548 = meta11548;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
})
audio_utils.worker.t_audio_utils$worker11547.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11549,meta11548__$1){
var self__ = this;
var _11549__$1 = this;
return (new audio_utils.worker.t_audio_utils$worker11547(self__.worker_exit_node,meta11548__$1));
});

audio_utils.worker.t_audio_utils$worker11547.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11549){
var self__ = this;
var _11549__$1 = this;
return self__.meta11548;
});

audio_utils.worker.t_audio_utils$worker11547.prototype.audio_utils$worker$IWorkerAudioNode$ = true;

audio_utils.worker.t_audio_utils$worker11547.prototype.audio_utils$worker$IWorkerAudioNode$connect$arity$2 = (function (this$,destination){
var self__ = this;
var this$__$1 = this;
return null;
});

audio_utils.worker.t_audio_utils$worker11547.prototype.audio_utils$worker$IWorkerAudioNode$disconnect$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return null;
});

audio_utils.worker.t_audio_utils$worker11547.prototype.audio_utils$worker$IWorkerAudioNode$process_audio$arity$2 = (function (this$,data){
var self__ = this;
var this$__$1 = this;
...
audio_utils.worker.t_audio_utils$worker11547.getBasis = (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"worker-exit-node","worker-exit-node",-1756103158,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),cljs.core.list(new cljs.core.Symbol(null,"quote","quote",1377916282,null),cljs.core.list(cljs.core.PersistentVector.EMPTY)),new cljs.core.Keyword(null,"doc","doc",1913296891),"Creates an IWorkerAudioNode that takes audio data from a previous\n   IWorkerAudioNode and forwards it to the main UI thread via a\n   :main-process-audio message."], null)),new cljs.core.Symbol(null,"meta11548","meta11548",2146758095,null)], null);
});

audio_utils.worker.t_audio_utils$worker11547.cljs$lang$type = true;

audio_utils.worker.t_audio_utils$worker11547.cljs$lang$ctorStr = "audio-utils.worker/t_audio_utils$worker11547";

audio_utils.worker.t_audio_utils$worker11547.cljs$lang$ctorPrWriter = (function (this__7084__auto__,writer__7085__auto__,opt__7086__auto__){
return cljs.core._write.call(null,writer__7085__auto__,"audio-utils.worker/t_audio_utils$worker11547");
});

audio_utils.worker.__GT_t_audio_utils$worker11547 = (function audio_utils$worker$worker_exit_node_$___GT_t_audio_utils$worker11547(worker_exit_node__$1,meta11548){
return (new audio_utils.worker.t_audio_utils$worker11547(worker_exit_node__$1,meta11548));
});

}

return (new audio_utils.worker.t_audio_utils$worker11547(audio_utils$worker$worker_exit_node,cljs.core.PersistentArrayMap.EMPTY));
});
